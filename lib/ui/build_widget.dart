...
class ControlMenu extends StatelessWidget {
  ...
  const ControlMenu(
      {Key key, this.onPressed, this.buttonColor, this.title, this.visible})
      : super(key: key);
...
class HotCard extends StatelessWidget {
  ...
  Widget _buildCryptoItem(BuildContext context) {
    ...
    if (currentPrice >= beforePrice) {
      _changeValue =
          '+$currency ${formatter.format(currentPrice - beforePrice)}';
    } else {
      _changeValue =
          '-$currency ${formatter.format(beforePrice - currentPrice)}';
    }
...
class StockCard extends StatelessWidget {
  ...
  const StockCard(
      {Key key, this.title, this.currentPrice, this.currency, this.beforePrice})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
